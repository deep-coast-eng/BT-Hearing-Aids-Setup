...
- If you are not sure, call your audiologist or the manufacturer and ask: *"Do my hearing aids support Bluetooth LE Audio for direct streaming to a Windows PC?"*
...
**Helpful resource:**
[HearingTracker](https://www.hearingtracker.com) is an independent website that reviews hearing aids and covers compatibility in plain language. It is a good starting point if you are researching a new device or are unsure about your current one.
...
If you see that setting, your computer is compatible.
If you do not see it, your computer does not currently support Bluetooth LE Audio and this tool will not be able to help without a hardware upgrade.
